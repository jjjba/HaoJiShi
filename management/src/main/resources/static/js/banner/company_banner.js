...
//初始化日期插件
    ...
    $('#editCompanyModal').on('hidden.bs.modal', function () {
        ...
        initFileInput("#editCompanyModal input[name=image_url][type=file]");
        ...
        $.ajax({
            url: $('#baseUrl').attr('href') + 'banner/updateCompanyBannerById',
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false
    ...
    $('#addCompanyModal').on('hidden.bs.modal', function () {
        ...
        var formData = new FormData($form[0]);
        $.ajax({
            url: $('#baseUrl').attr('href') + 'banner/insertCompanyBanner',
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false
...
function loadData(page, size) {
    ...
    $.ajax({
        type: "GET",
        url: $('#baseUrl').attr('href') + "banner/getAllCompanyBanner",
        data: data,
