...
public class JuheSms {
    ...
    public static void getRequest2(String mobile, String tpl_id, String code, String APPKEY) {
        String result = null;
    ...
    public static String urlencode(Map<String, Object> data) {
        ...
        for (Map.Entry i : data.entrySet()) {
            try {
                sb.append(i.getKey()).append("=").append(URLEncoder.encode(String.valueOf(i.getValue()), "UTF-8")).append("&");
