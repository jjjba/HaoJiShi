 ...
 * @option_param {number} width 鎴彇鍖哄煙鐨勫搴�
 * @option_param {number} height 鎴彇鍖哄煙鐨勯珮搴�
 ...
 * @option_param {string} outputType 鎸囧畾杈撳嚭鍥剧墖鐨勭被鍨嬶紝鍙€� "jpg" 鍜� "png" 涓ょ绉嶇被鍨嬶紝榛樿涓� "jpg"
 * @option_param {boolean} strictSize 鏄惁涓ユ牸鎸夌収鎴彇鍖哄煙瀹介珮瑁佸壀銆傞粯璁や负false锛岃〃绀烘埅鍙栧尯鍩熷楂樹粎鐢ㄤ簬绾︽潫瀹介珮姣斾緥銆傚鏋滆缃负true锛屽垯琛ㄧず鎴彇鍑虹殑鍥惧儚瀹介珮涓ユ牸鎸夌収鎴彇鍖哄煙瀹介珮杈撳嚭
...
(function(root, factory) {
	...
	if (typeof define === "function" && define.amd) {
		define(["jquery", "static/company/js/zhu_ce_tian_xie_xin_xi/iscroll-zoom", "zhu_ce_tian_xie_xin_xi/hammer"], factory);
	} else if (typeof exports === "object") {
		module.exports = factory(require("jquery"), require("static/company/js/zhu_ce_tian_xie_xin_xi/iscroll-zoom"), require("static/company/js/zhu_ce_tian_xie_xin_xi/hammer"));
	} else {
